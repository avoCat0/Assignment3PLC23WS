...
fn main() {
    ...
    let width = 1024; // Beispielwert
    let height = 768; // Beispielwert
    let max_iterations = 1000; // Beispielwert oder Standardwert

    // Generieren Sie das Bild mit der Mandelbrot-Set-Logik
    let _image = mandelbrot::generate_image(width, height, max_iterations);
